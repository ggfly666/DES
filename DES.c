...
int DES_ByteToBit(ElemType ch, ElemType bit[8]);
int DES_BitToByte(ElemType bit[8], ElemType *ch);
int DES_Char8ToBit64(ElemType ch[8], ElemType bit[64]);
int DES_Bit64ToChar8(ElemType bit[64], ElemType ch[8]);
int DES_MakeSubKeys(ElemType key[64], ElemType subKeys[16][48]);
int DES_PC1_Transform(ElemType key[64], ElemType tempbts[56]);
int DES_PC2_Transform(ElemType key[64], ElemType tempbts[48]);
...
int main(){
    char key[8];
    printf("============================================\n");
    printf("                 DES -- a test cpoy         \n");
    printf("============================================\n");
    printf("Please enter an encryption and decryption key with a length of 8 characters:");
    gets(key);
    printf("Reading in plaintext file 1. txt...\n");
    printf("Encrypting...\n");
    printf("Encrypted files are stored in a 2. txt file...\n");
    DES_Encrypt("1.txt", key, "2.txt");
    printf("Read in ciphertext file 2. txt...\n");
    DES_Decrypt("2.txt", key, "3.txt");
    printf("Decrypting...\n");
    printf("Decrypting files stored in a 3. txt file...\n");
    printf("Ends\n");
    return 0;
}
