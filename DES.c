...
#define PLAIN_OPEN_ERROR  -1
#define KEY_OPEN_ERROR    -2
#define CIPHER_OPEN_ERROR -3
#define OK                1
...
int main()
{
    ...
    printf("=======读入明文文件1.txt...\n");
    printf("=======正在加密...\n");
    printf("=======加密文件存储在2.txt中...\n");
    DES_Encrypt("1.txt", key, "2.txt");
    printf("=======读入密文文件2.txt...\n");
    DES_Decrypt("2.txt", key, "3.txt");
    printf("=======正在解密...\n");
    printf("=======解密文件存储在3.txt中...\n");
    printf("=======DES算法加解密算法演示结束============================\n");
    return 0;
}
